...
const closeModal = () => {
  selectedPostContent.value = null;
...
<template>
  <div>
    <div class="container">
      <!-- ... -->
      <div class="container mt-10" v-if="enrichedPosts.length">
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
              ...
              <div>
                <button
                  ...
                  @click="openModal(post.post_content)"
      ...
      <div v-else class="w-full mt-10 text-center text-lg font-medium">
    ...
    <div class="container">
      ...
      <div class="w-full mt-10" v-if="enrichedPosts.length">
        <div v-for="post in enrichedPosts" :key="post.id" class="post">
          <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
              <div>
      ...
      <!-- Event move.. Modal show detail post_contents -->
      <div v-if="isModalOpen" class="modal-overlay">
        <div class="modal-container">
          <button @click="closeModal" class="modal-close">X</button>
          <div class="modal-content">
