          ...
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center">
              <div class="hidden md:block" v-if="storeUser">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <div
                    v-if="
                      storeUser.user_login.status_id === 1 ||
                      storeUser.user_login.status_id === 2
                    "
                  >
                    <RouterLink
                      class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"
            ...
            <div class="relative ml-3" v-if="authStore.storeUser">
              ...
              <div>
                ...
                >
                  ...
                  <div v-if="storeUser.user_login?.userProfileImage">
                    <div
                      v-for="profileImage in storeUser.user_login
                        .userProfileImage"
                      :key="profileImage?.id"
                    >
                      <img
              ...
              <p class="text-gray-100 text-lg">
                {{ authStore.storeUser.user_login.userProfileImage.imageData }}
              </p>
            </div>
            <!-- *************** Profile dropdown Auth true************************** -->
